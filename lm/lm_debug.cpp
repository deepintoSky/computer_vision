...
using namespace cv;
vector<double> x = { 0,0.1000,0.2000,0.3000,0.4000,0.5000,0.6000,0.7000,
	...
	vector<double> y = { 84.8813,146.7663,149.6254,93.1977,3.6583,-104.9392,
...
int main( )
{
	Vector2d p(2, 1), p_optim(2, 1), p_update(2, 1), h(2, 1); 
	vector<double>  y_hat(63, 1);
	MatrixXd jeco(63, 2), w(2, 2), err(63, 1), err_update(63, 1);
